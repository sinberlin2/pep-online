...
Outputs: brand/inputs/external-designs/pep-original/product/flavours/bg_removed/{slug}-background-removed.png
...
CONCEPT_DIR = ROOT / "brand" / "inputs" / "external-designs" / "pep-original"
