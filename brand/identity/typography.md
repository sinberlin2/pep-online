...
**Brittany Signature** is not on Google Fonts. The site uses `Segoe Script` as a temporary fallback until you add licensed files under `brand/identity/fonts/`.

## Adding Brittany Signature (optional)

1. Place `BrittanySignature.woff2` in `brand/identity/fonts/`
